...
<template>
  <div class="min-h-screen w-screen">
    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-12 mx-auto flex items-center flex-col">
        <div class="flex flex-col mb-6 pr-0 w-full text-center">
          <h2
            class="text-xl text-red-400 tracking-widest title-font mb-5 font-semibold"
          >
            お申し込みいただき、ありがとうございます。
          </h2>
          <h1 class="text-md font-medium title-font text-gray-900">
            ご注文を承りました。
          </h1>
        </div>
        <div class="flex mx-auto items-center flex-shrink-0 space-x-4">
          <button
            class="bg-gray-100 inline-flex py-3 px-4 rounded-lg items-center hover:bg-gray-200 focus:outline-none"
          >
            <path
